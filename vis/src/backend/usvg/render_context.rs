...
impl Vis<BitmapDevice> for TextLabel {
    ...
    fn vis(&self, _rc: &mut BitmapDevice, _ts: TranslateScale, _style: Option<&Style>, _theme: &Theme) {
        unreachable!()
    }

    fn vis_mut(&mut self, rc: &mut BitmapDevice, ts: TranslateScale, style: Option<&Style>, theme: &Theme) {
